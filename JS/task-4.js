...
const droidItem = prompt("Сколько Дроидов вы хотите купить?");
// console.log(droidItem);
let totalPrice = droidItem * pricePerDroid;
...
if (droidItem === null) {
  ...
  alert(
    `Вы купили ${droidItem} дроидов, на счету осталось ${balance} кредитов.`
  );
}
